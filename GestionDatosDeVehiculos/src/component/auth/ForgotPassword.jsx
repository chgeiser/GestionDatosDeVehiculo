...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsSuccess(true) // Mostrar éxito igual
    } finally {
      setIsLoading(false)
    }
  }
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Si existe una cuenta con <strong>{email}</strong>, recibirás instrucciones 
            ...
            <Link 
              to="/login" 
              className="mt-6 inline-flex items-center gap-2 text-gray-600 hover:text-gray-900"
            >
